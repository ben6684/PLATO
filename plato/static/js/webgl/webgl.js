...
function drawScene() {
    ...
    gl.uniform1i(shaderProgram.useTexturingUniform, texturing);

    gl.uniform1i(shaderProgram.usePointSet, document.getElementById("pointSet").checked);
    gl.uniform1i(shaderProgram.useSmoothedPoint, document.getElementById("smoothedPoint").checked);
